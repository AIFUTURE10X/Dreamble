...
export const ASPECT_RATIO_OPTIONS: { group: string, options: { value: string, label: string }[] }[] = [
    {
        group: "Common",
        options: [
    ...
    },
    {
        group: "Social Media",
        options: [
            { value: "1:1", label: "1:1 (Insta Post)" },
...
export const STYLE_TAXONOMY: { [key: string]: Substyle[] } = {
    "🎞️ Animation": [
        { name: "Anime", description: "Japanese animation style, characterized by vibrant colors, dramatic action, and expressive characters.", tags: ["Expressive Characters", "Vibrant Colors"], icon: "🌸", previewImageUrl: '/assets/anime.webp' },
        { name: "Kawaii", description: "Cute, colorful and charming art style with rounded features.", tags: ["Cute", "Pastel Colors"], icon: "🎀", previewImageUrl: '/assets/kawaii.webp' },
        { name: "Studio Ghibli", description: "Evokes the hand-drawn, enchanting style of Studio Ghibli films, known for lush landscapes and heartfelt storytelling.", tags: ["Whimsical", "Natural Settings"], icon: "🍃", previewImageUrl: '/assets/studio-ghibli.webp' },
        { name: "Disney Style", description: "Classic family-friendly animation with smooth features.", tags: ["Smooth features", "Bright colors"], icon: "✨", previewImageUrl: '/assets/disney-style.webp' },
        { 
            name: "Pixar Style", 
            ...
            icon: "💡",
            previewImageUrl: '/assets/pixar-style.webp',
        ...
        { name: "2D Animation", description: "Traditional flat animation style, reminiscent of classic cartoons and hand-drawn art.", tags: ["Flat Design", "Bold Colors"], icon: "✏️", previewImageUrl: '/assets/2d-animation.webp' },
        { name: "3D Animation", description: "Computer-generated 3D models and environments, offering depth, realism, and complex lighting.", icon: "🧊", previewImageUrl: '/assets/3d-animation.webp' },
        ...
        { name: "Comic Book", description: "Mimics Western comic books, with bold outlines, halftone dots (Ben-Day dots), and dynamic paneling.", tags: ["Bold Outlines", "Dynamic Paneling"], icon: "💥", previewImageUrl: '/assets/comic-book.webp' },
        { name: "Manga", description: "Japanese comic art style, typically in black and white with expressive linework and dynamic action.", icon: "📖", previewImageUrl: '/assets/manga.webp' },
        ...
        { name: "Minecraft", description: "A blocky, pixelated art style inspired by the video game Minecraft.", icon: "🧱", previewImageUrl: '/assets/minecraft.webp' },
    ...
    "📸 Realism": [
        { name: "Realistic", description: "A style that aims to represent subjects truthfully, without artificiality.", previewImageUrl: '/assets/realistic.webp' },
        { name: "Photorealistic", description: "Aims to reproduce an image as realistically as a photograph.", previewImageUrl: '/assets/photorealistic.webp' },
        { name: "Hyperrealism", description: "A genre resembling a high-resolution photograph, often with an emphasis on fine details and textures.", previewImageUrl: '/assets/hyperrealism.webp' },
        { name: "Cinematic", description: "A style that mimics the look of a movie, often with dramatic lighting, specific color grading, and a widescreen feel.", previewImageUrl: '/assets/cinematic.webp' },
        { name: "HDR (High Dynamic Range)", description: "Creates a more dramatic image with a greater range of detail in both the shadows and highlights.", previewImageUrl: '/assets/hdr.webp' }
    ],
    "🔮 Fantasy": [
        { name: "Dark Fantasy", description: "A subgenre that combines fantasy with elements of horror, creating a dark, frightening, and often gloomy atmosphere.", previewImageUrl: '/assets/dark-fantasy.webp' },
        { name: "Fairy Tale", description: "A whimsical and magical style, often featuring fantastical creatures, enchanted forests, and castles.", previewImageUrl: '/assets/fairy-tale.webp' },
        { name: "Mythical", description: "A style inspired by myths, legends, and folklore, often featuring gods, heroes, and epic creatures." },
        { name: "Dreamlike", description: "A surreal and ethereal style, characterized by soft focus, strange juxtapositions, and a sense of unreality.", previewImageUrl: '/assets/dreamlike.webp' },
        { name: "Dreamcore", description: "An aesthetic based on dreams and surreal imagery, often with a nostalgic or unsettling feeling." }
    ],
    "🚀 Sci-Fi": [
        { name: "Cyberpunk", description: "A futuristic, high-tech, low-life setting, often featuring neon lights, cybernetics, and dystopian cityscapes.", previewImageUrl: '/assets/cyberpunk.webp' },
        { name: "Steampunk", description: "A retrofuturistic style inspired by 19th-century industrial steam-powered machinery.", previewImageUrl: '/assets/steampunk.webp' },
        { name: "Solarpunk", description: "An optimistic vision of the future, focusing on renewable energy, nature, and sustainable technology.", previewImageUrl: '/assets/solarpunk.webp' },
        ...
        { name: "Retro-Futurism", description: "A vision of the future from the perspective of an earlier era, often the mid-20th century.", previewImageUrl: '/assets/retro-futurism.webp' },
        { name: "Synthwave", description: "A retro aesthetic inspired by 1980s film, video game, and music culture, with neon grids and futuristic cars.", previewImageUrl: '/assets/synthwave.webp' },
    ...
    "🖌️ Painting": [
        { name: "Oil Painting", description: "Rich, deep colors with a visible texture, mimicking traditional oil on canvas.", previewImageUrl: '/assets/oil-painting.webp' },
        { name: "Watercolor", description: "Soft, translucent colors with a fluid and often spontaneous appearance.", previewImageUrl: '/assets/watercolor.webp' },
        { name: "Acrylic Painting", description: "Bold, vibrant colors with a fast-drying, plastic-like finish.", previewImageUrl: '/assets/acrylic-painting.webp' },
        ...
        { name: "Pointillism", description: "A technique using tiny dots of color that blend in the viewer's eye.", previewImageUrl: '/assets/pointillism.webp' },
        ...
        { name: "Impressionism", description: "Characterized by small, thin, yet visible brush strokes, and an accurate depiction of light.", previewImageUrl: '/assets/impressionism.webp' },
        ...
        { name: "Surrealism", description: "Features dream-like, bizarre, and illogical scenes.", previewImageUrl: '/assets/surrealism.webp' },
        { name: "Abstract", description: "Uses visual language of shape, form, color, and line to create a composition which may exist with a degree of independence from visual references.", previewImageUrl: '/assets/abstract.webp' },
        { name: "Pop Art", description: "Characterized by bold imagery, bright color palettes, and iconography from popular culture.", previewImageUrl: '/assets/pop-art.webp' },
    ...
    "🏛️ Heritage": [
        { name: "Ukiyo-e", description: "Japanese woodblock prints from the Edo period, featuring subjects from history, landscapes, and kabuki actors.", previewImageUrl: '/assets/ukiyo-e.webp' },
        ...
        { name: "Art Deco", description: "A style from the 1920s and 1930s, characterized by geometric shapes, rich colors, and lavish ornamentation.", previewImageUrl: '/assets/art-deco.webp' },
        ...
        { name: "Minimalist", description: "A style that uses pared-down design elements.", previewImageUrl: '/assets/minimalist.webp' },
        { name: "Line Art", description: "A style consisting of distinct straight or curved lines placed against a (usually plain) background, without gradations in shade or hue.", previewImageUrl: '/assets/line-art.webp' },
        ...
        { name: "Sketch", description: "A rapidly executed freehand drawing that is not usually intended as a finished work.", previewImageUrl: '/assets/sketch.webp' },
    ...
    "🎨 Drawing": [
        { name: "Pencil", description: "A classic drawing style using graphite pencils, allowing for a wide range of tones and textures.", previewImageUrl: '/assets/pencil.webp' },
        { name: "Charcoal", description: "A drawing style using charcoal, known for its rich, dark lines and soft, blendable quality.", previewImageUrl: '/assets/charcoal.webp' },
        { name: "Ink", description: "A style using liquid ink, often with pens or brushes, to create bold, high-contrast images.", previewImageUrl: '/assets/ink.webp' },
    ...
    "💻 Digital Art": [
        { name: "Pixel", description: "A form of digital art, created through the use of software, where images are edited on the pixel level.", previewImageUrl: '/assets/pixel.webp' },
        { name: "Vector", description: "A form of computer graphics in which visual images are created directly from geometric shapes.", previewImageUrl: '/assets/vector.webp' },
        { name: "3D Render", description: "The process of creating a 2D image from a 3D model.", previewImageUrl: '/assets/3d-render.webp' },
        ...
        { name: "Low Poly", description: "A polygon mesh in 3D computer graphics that has a relatively small number of polygons.", previewImageUrl: '/assets/low-poly.webp' },
